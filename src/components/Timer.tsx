  ...
  return (
    <div className="flex flex-col justify-center items-center py-20">
      ...
      <div className="font-mono text-3xl font-bold py-28"> 
        <button onClick={toggleTimer} className="px-4 py-2 bg-gray-300 text-gray-700 font-semibold rounded-lg shadow-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">
